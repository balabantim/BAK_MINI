...
#ifndef BAKFRAMEWORKMINI_SWIFT_H
#define BAKFRAMEWORKMINI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BAKFrameworkMini",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16BAKFrameworkMini14BAKAppDelegate")
@interface BAKAppDelegate : UIResponder <UIApplicationDelegate>
...
SWIFT_CLASS("_TtC16BAKFrameworkMini3PVC")
